...
// Export a subset of iNat data to test on BOLD model
...
INNER JOIN shared ON annotation.category_id = shared.cat_id
WHERE  category.id=1501';
...
{
	case 1:
		$filename = 'val-inat.json';
		break;

	case 2:
		$filename = 'test-inat.json';
		break;
}
